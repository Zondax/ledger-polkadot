...
parser_error_t check_swap_conditions(parser_tx_t *txObj) {
    ...
    if (strcmp("polkadot", tmpValue) != 0 && strcmp("statemint", tmpValue) != 0) {
    ...
    const char *valid_tx_call_1 = "transfer_allow_death";
    const char *valid_tx_call_2 = "transfer_keep_alive";
