...
parser_error_t _readMethod_V15(parser_context_t* c, uint8_t moduleIdx, uint8_t callIdx, pd_Method_V15_t* method);
...
parser_error_t _getMethod_ItemValue_V15(
    pd_Method_V15_t* m, uint8_t moduleIdx, uint8_t callIdx, uint8_t itemIdx,
