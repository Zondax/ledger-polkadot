    ...
    pd_Method_V15_t* method)
{
    ...
    case 3594: /* module 14 call 10 */
        CHECK_ERROR(_readMethod_democracy_cancel_queued_V15(c, &method->nested.democracy_cancel_queued_V15))
        break;
    ...
    case 3602: /* module 14 call 18 */
        CHECK_ERROR(_readMethod_democracy_reap_preimage_V15(c, &method->nested.democracy_reap_preimage_V15))
        break;
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 3584: /* module 14 call 0 */
        ...
        case 0: /* democracy_propose_V15 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_propose_V15.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 3585: /* module 14 call 1 */
        ...
        case 1: /* democracy_second_V15 - seconds_upper_bound */;
            return _toStringCompactu32(
                &m->nested.democracy_second_V15.seconds_upper_bound,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3588: /* module 14 call 4 */
        ...
        case 0: /* democracy_external_propose_V15 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_external_propose_V15.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3589: /* module 14 call 5 */
        ...
        case 0: /* democracy_external_propose_majority_V15 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_external_propose_majority_V15.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3590: /* module 14 call 6 */
        ...
        case 0: /* democracy_external_propose_default_V15 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_external_propose_default_V15.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3594: /* module 14 call 10 */
        ...
        case 0: /* democracy_cancel_queued_V15 - which */;
            return _toStringReferendumIndex_V15(
                &m->nested.democracy_cancel_queued_V15.which,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3602: /* module 14 call 18 */
        ...
        case 0: /* democracy_reap_preimage_V15 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_reap_preimage_V15.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_reap_preimage_V15 - proposal_len_upper_bound */;
            return _toStringCompactu32(
                &m->nested.democracy_reap_preimage_V15.proposal_len_upper_bound,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3606: /* module 14 call 22 */
        ...
        case 0: /* democracy_enact_proposal_V15 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_enact_proposal_V15.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
