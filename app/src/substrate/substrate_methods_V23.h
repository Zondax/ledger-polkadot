...
#define PD_CALL_PREIMAGE_V23 10
#define PD_CALL_TIMESTAMP_V23 3
#define PD_CALL_INDICES_V23 4
#define PD_CALL_BALANCES_V23 5
#define PD_CALL_STAKING_V23 7
#define PD_CALL_SESSION_V23 9
#define PD_CALL_DEMOCRACY_V23 14
#define PD_CALL_COUNCIL_V23 15
#define PD_CALL_TECHNICALCOMMITTEE_V23 16
#define PD_CALL_PHRAGMENELECTION_V23 17
#define PD_CALL_TECHNICALMEMBERSHIP_V23 18
#define PD_CALL_TREASURY_V23 19
#define PD_CALL_CONVICTIONVOTING_V23 20
#define PD_CALL_REFERENDA_V23 21
#define PD_CALL_WHITELIST_V23 23
#define PD_CALL_CLAIMS_V23 24
#define PD_CALL_VESTING_V23 25
#define PD_CALL_UTILITY_V23 26
#define PD_CALL_IDENTITY_V23 28
#define PD_CALL_PROXY_V23 29
#define PD_CALL_MULTISIG_V23 30
#define PD_CALL_BOUNTIES_V23 34
#define PD_CALL_CHILDBOUNTIES_V23 38
#define PD_CALL_TIPS_V23 35
#define PD_CALL_VOTERLIST_V23 37
#define PD_CALL_NOMINATIONPOOLS_V23 39
#define PD_CALL_FASTUNSTAKE_V23 40
#define PD_CALL_CONFIGURATION_V23 51
#define PD_CALL_INITIALIZER_V23 57
#define PD_CALL_UMP_V23 59
...
#define PD_CALL_DEMOCRACY_BLACKLIST_V23 16
typedef struct {
    pd_H256_t proposal_hash;
    pd_OptionReferendumIndex_t maybe_ref_index;
} pd_democracy_blacklist_V23_t;

#define PD_CALL_DEMOCRACY_SET_METADATA_V23 18
typedef struct {
    pd_MetadataOwner_t owner;
    pd_OptionPreimageHash_t maybe_hash;
} pd_democracy_set_metadata_V23_t;

#define PD_CALL_COUNCIL_SET_MEMBERS_V23 0
typedef struct {
    pd_VecAccountId_t new_members;
    pd_OptionAccountId_t prime;
    pd_MemberCount_t old_count;
} pd_council_set_members_V23_t;

#define PD_CALL_COUNCIL_EXECUTE_V23 1
typedef struct {
    pd_Proposal_t proposal;
    pd_Compactu32_t length_bound;
} pd_council_execute_V23_t;

#define PD_CALL_COUNCIL_PROPOSE_V23 2
typedef struct {
    pd_Compactu32_t threshold;
    pd_Proposal_t proposal;
    pd_Compactu32_t length_bound;
} pd_council_propose_V23_t;

#define PD_CALL_COUNCIL_VOTE_V23 3
typedef struct {
    pd_Hash_t proposal;
    pd_Compactu32_t index;
    pd_bool_t approve;
} pd_council_vote_V23_t;

#define PD_CALL_COUNCIL_DISAPPROVE_PROPOSAL_V23 5
typedef struct {
    pd_Hash_t proposal_hash;
} pd_council_disapprove_proposal_V23_t;

#define PD_CALL_COUNCIL_CLOSE_V23 6
typedef struct {
    pd_Hash_t proposal_hash;
    pd_Compactu32_t index;
    pd_Weight_t proposal_weight_bound;
    pd_Compactu32_t length_bound;
} pd_council_close_V23_t;

#define PD_CALL_TECHNICALCOMMITTEE_SET_MEMBERS_V23 0
typedef struct {
    pd_VecAccountId_t new_members;
    pd_OptionAccountId_t prime;
    pd_MemberCount_t old_count;
} pd_technicalcommittee_set_members_V23_t;

#define PD_CALL_TECHNICALCOMMITTEE_EXECUTE_V23 1
typedef struct {
    pd_Proposal_t proposal;
    pd_Compactu32_t length_bound;
} pd_technicalcommittee_execute_V23_t;

#define PD_CALL_TECHNICALCOMMITTEE_PROPOSE_V23 2
typedef struct {
    pd_Compactu32_t threshold;
    pd_Proposal_t proposal;
    pd_Compactu32_t length_bound;
} pd_technicalcommittee_propose_V23_t;

#define PD_CALL_TECHNICALCOMMITTEE_VOTE_V23 3
typedef struct {
    pd_Hash_t proposal;
    pd_Compactu32_t index;
    pd_bool_t approve;
} pd_technicalcommittee_vote_V23_t;

#define PD_CALL_TECHNICALCOMMITTEE_DISAPPROVE_PROPOSAL_V23 5
typedef struct {
    pd_Hash_t proposal_hash;
} pd_technicalcommittee_disapprove_proposal_V23_t;

#define PD_CALL_TECHNICALCOMMITTEE_CLOSE_V23 6
typedef struct {
    pd_Hash_t proposal_hash;
    pd_Compactu32_t index;
    pd_Weight_t proposal_weight_bound;
    pd_Compactu32_t length_bound;
} pd_technicalcommittee_close_V23_t;

#define PD_CALL_PHRAGMENELECTION_VOTE_V23 0
typedef struct {
    pd_VecAccountId_t votes;
    pd_CompactBalance_t amount;
} pd_phragmenelection_vote_V23_t;

#define PD_CALL_PHRAGMENELECTION_REMOVE_VOTER_V23 1
typedef struct {
} pd_phragmenelection_remove_voter_V23_t;

#define PD_CALL_PHRAGMENELECTION_SUBMIT_CANDIDACY_V23 2
typedef struct {
    pd_Compactu32_t candidate_count;
} pd_phragmenelection_submit_candidacy_V23_t;

#define PD_CALL_PHRAGMENELECTION_REMOVE_MEMBER_V23 4
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_bool_t slash_bond;
    pd_bool_t rerun_election;
} pd_phragmenelection_remove_member_V23_t;

#define PD_CALL_PHRAGMENELECTION_CLEAN_DEFUNCT_VOTERS_V23 5
typedef struct {
    pd_u32_t num_voters;
    pd_u32_t num_defunct;
} pd_phragmenelection_clean_defunct_voters_V23_t;

#define PD_CALL_TECHNICALMEMBERSHIP_ADD_MEMBER_V23 0
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_technicalmembership_add_member_V23_t;

#define PD_CALL_TECHNICALMEMBERSHIP_REMOVE_MEMBER_V23 1
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_technicalmembership_remove_member_V23_t;

#define PD_CALL_TECHNICALMEMBERSHIP_SWAP_MEMBER_V23 2
typedef struct {
    pd_AccountIdLookupOfT_t remove;
    pd_AccountIdLookupOfT_t add;
} pd_technicalmembership_swap_member_V23_t;

#define PD_CALL_TECHNICALMEMBERSHIP_RESET_MEMBERS_V23 3
typedef struct {
    pd_VecAccountId_t members;
} pd_technicalmembership_reset_members_V23_t;

#define PD_CALL_TECHNICALMEMBERSHIP_CHANGE_KEY_V23 4
typedef struct {
    pd_AccountIdLookupOfT_t new_;
} pd_technicalmembership_change_key_V23_t;

#define PD_CALL_TECHNICALMEMBERSHIP_SET_PRIME_V23 5
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_technicalmembership_set_prime_V23_t;

#define PD_CALL_TECHNICALMEMBERSHIP_CLEAR_PRIME_V23 6
typedef struct {
} pd_technicalmembership_clear_prime_V23_t;
...
#define PD_CALL_TIPS_REPORT_AWESOME_V23 0
typedef struct {
    pd_Bytes_t reason;
    pd_AccountIdLookupOfT_t who;
} pd_tips_report_awesome_V23_t;

#define PD_CALL_TIPS_RETRACT_TIP_V23 1
typedef struct {
    pd_Hash_t hash;
} pd_tips_retract_tip_V23_t;

#define PD_CALL_TIPS_TIP_NEW_V23 2
typedef struct {
    pd_Bytes_t reason;
    pd_AccountIdLookupOfT_t who;
    pd_Compactu128_t tip_value;
} pd_tips_tip_new_V23_t;

#define PD_CALL_TIPS_TIP_V23 3
typedef struct {
    pd_Hash_t hash;
    pd_Compactu128_t tip_value;
} pd_tips_tip_V23_t;

#define PD_CALL_TIPS_CLOSE_TIP_V23 4
typedef struct {
    pd_Hash_t hash;
} pd_tips_close_tip_V23_t;

#define PD_CALL_TIPS_SLASH_TIP_V23 5
typedef struct {
    pd_Hash_t hash;
} pd_tips_slash_tip_V23_t;
...
#define PD_CALL_CONFIGURATION_SET_UMP_SERVICE_TOTAL_WEIGHT_V23 26
typedef struct {
    pd_Weight_t new_;
} pd_configuration_set_ump_service_total_weight_V23_t;
...
#define PD_CALL_CONFIGURATION_SET_UMP_MAX_INDIVIDUAL_WEIGHT_V23 40
typedef struct {
    pd_Weight_t new_;
} pd_configuration_set_ump_max_individual_weight_V23_t;
...
#define PD_CALL_UMP_SERVICE_OVERWEIGHT_V23 0
typedef struct {
    pd_OverweightIndex_t index;
    pd_Weight_t weight_limit;
} pd_ump_service_overweight_V23_t;
...
typedef union {
    ...
    pd_democracy_blacklist_V23_t democracy_blacklist_V23;
    pd_democracy_set_metadata_V23_t democracy_set_metadata_V23;
    pd_council_set_members_V23_t council_set_members_V23;
    pd_council_execute_V23_t council_execute_V23;
    pd_council_propose_V23_t council_propose_V23;
    pd_council_vote_V23_t council_vote_V23;
    pd_council_disapprove_proposal_V23_t council_disapprove_proposal_V23;
    pd_council_close_V23_t council_close_V23;
    pd_technicalcommittee_set_members_V23_t technicalcommittee_set_members_V23;
    pd_technicalcommittee_execute_V23_t technicalcommittee_execute_V23;
    pd_technicalcommittee_propose_V23_t technicalcommittee_propose_V23;
    pd_technicalcommittee_vote_V23_t technicalcommittee_vote_V23;
    pd_technicalcommittee_disapprove_proposal_V23_t technicalcommittee_disapprove_proposal_V23;
    pd_technicalcommittee_close_V23_t technicalcommittee_close_V23;
    pd_phragmenelection_vote_V23_t phragmenelection_vote_V23;
    pd_phragmenelection_remove_voter_V23_t phragmenelection_remove_voter_V23;
    pd_phragmenelection_submit_candidacy_V23_t phragmenelection_submit_candidacy_V23;
    pd_phragmenelection_remove_member_V23_t phragmenelection_remove_member_V23;
    pd_phragmenelection_clean_defunct_voters_V23_t phragmenelection_clean_defunct_voters_V23;
    pd_technicalmembership_add_member_V23_t technicalmembership_add_member_V23;
    pd_technicalmembership_remove_member_V23_t technicalmembership_remove_member_V23;
    pd_technicalmembership_swap_member_V23_t technicalmembership_swap_member_V23;
    pd_technicalmembership_reset_members_V23_t technicalmembership_reset_members_V23;
    pd_technicalmembership_change_key_V23_t technicalmembership_change_key_V23;
    pd_technicalmembership_set_prime_V23_t technicalmembership_set_prime_V23;
    pd_technicalmembership_clear_prime_V23_t technicalmembership_clear_prime_V23;
    ...
    pd_tips_report_awesome_V23_t tips_report_awesome_V23;
    pd_tips_retract_tip_V23_t tips_retract_tip_V23;
    pd_tips_tip_new_V23_t tips_tip_new_V23;
    pd_tips_tip_V23_t tips_tip_V23;
    pd_tips_close_tip_V23_t tips_close_tip_V23;
    pd_tips_slash_tip_V23_t tips_slash_tip_V23;
    ...
    pd_configuration_set_ump_service_total_weight_V23_t configuration_set_ump_service_total_weight_V23;
    ...
    pd_configuration_set_ump_max_individual_weight_V23_t configuration_set_ump_max_individual_weight_V23;
    ...
    pd_ump_service_overweight_V23_t ump_service_overweight_V23;
...
#define PD_CALL_DEMOCRACY_PROPOSE_V23 0
typedef struct {
    pd_BoundedCallOfT_t proposal;
    pd_CompactBalance_t amount;
} pd_democracy_propose_V23_t;

#define PD_CALL_DEMOCRACY_SECOND_V23 1
typedef struct {
    pd_Compactu32_t proposal;
} pd_democracy_second_V23_t;

#define PD_CALL_DEMOCRACY_VOTE_V23 2
typedef struct {
    pd_Compactu32_t ref_index;
    pd_AccountVote_t vote;
} pd_democracy_vote_V23_t;

#define PD_CALL_DEMOCRACY_EMERGENCY_CANCEL_V23 3
typedef struct {
    pd_ReferendumIndex_t ref_index;
} pd_democracy_emergency_cancel_V23_t;

#define PD_CALL_DEMOCRACY_EXTERNAL_PROPOSE_V23 4
typedef struct {
    pd_BoundedCallOfT_t proposal;
} pd_democracy_external_propose_V23_t;

#define PD_CALL_DEMOCRACY_EXTERNAL_PROPOSE_MAJORITY_V23 5
typedef struct {
    pd_BoundedCallOfT_t proposal;
} pd_democracy_external_propose_majority_V23_t;

#define PD_CALL_DEMOCRACY_EXTERNAL_PROPOSE_DEFAULT_V23 6
typedef struct {
    pd_BoundedCallOfT_t proposal;
} pd_democracy_external_propose_default_V23_t;

#define PD_CALL_DEMOCRACY_FAST_TRACK_V23 7
typedef struct {
    pd_H256_t proposal_hash;
    pd_BlockNumber_t voting_period;
    pd_BlockNumber_t delay;
} pd_democracy_fast_track_V23_t;

#define PD_CALL_DEMOCRACY_VETO_EXTERNAL_V23 8
typedef struct {
    pd_H256_t proposal_hash;
} pd_democracy_veto_external_V23_t;

#define PD_CALL_DEMOCRACY_CANCEL_REFERENDUM_V23 9
typedef struct {
    pd_Compactu32_t ref_index;
} pd_democracy_cancel_referendum_V23_t;

#define PD_CALL_DEMOCRACY_DELEGATE_V23 10
typedef struct {
    pd_AccountIdLookupOfT_t to;
    pd_Conviction_t conviction;
    pd_Balance_t balance;
} pd_democracy_delegate_V23_t;

#define PD_CALL_DEMOCRACY_UNDELEGATE_V23 11
typedef struct {
} pd_democracy_undelegate_V23_t;

#define PD_CALL_DEMOCRACY_CLEAR_PUBLIC_PROPOSALS_V23 12
typedef struct {
} pd_democracy_clear_public_proposals_V23_t;

#define PD_CALL_DEMOCRACY_UNLOCK_V23 13
typedef struct {
    pd_AccountIdLookupOfT_t target;
} pd_democracy_unlock_V23_t;

#define PD_CALL_DEMOCRACY_REMOVE_VOTE_V23 14
typedef struct {
    pd_ReferendumIndex_t index;
} pd_democracy_remove_vote_V23_t;

#define PD_CALL_DEMOCRACY_REMOVE_OTHER_VOTE_V23 15
typedef struct {
    pd_AccountIdLookupOfT_t target;
    pd_ReferendumIndex_t index;
} pd_democracy_remove_other_vote_V23_t;

#define PD_CALL_DEMOCRACY_CANCEL_PROPOSAL_V23 17
typedef struct {
    pd_Compactu32_t prop_index;
} pd_democracy_cancel_proposal_V23_t;
...
typedef union {
    ...
    pd_democracy_propose_V23_t democracy_propose_V23;
    pd_democracy_second_V23_t democracy_second_V23;
    pd_democracy_vote_V23_t democracy_vote_V23;
    pd_democracy_emergency_cancel_V23_t democracy_emergency_cancel_V23;
    pd_democracy_external_propose_V23_t democracy_external_propose_V23;
    pd_democracy_external_propose_majority_V23_t democracy_external_propose_majority_V23;
    pd_democracy_external_propose_default_V23_t democracy_external_propose_default_V23;
    pd_democracy_fast_track_V23_t democracy_fast_track_V23;
    pd_democracy_veto_external_V23_t democracy_veto_external_V23;
    pd_democracy_cancel_referendum_V23_t democracy_cancel_referendum_V23;
    pd_democracy_delegate_V23_t democracy_delegate_V23;
    pd_democracy_undelegate_V23_t democracy_undelegate_V23;
    pd_democracy_clear_public_proposals_V23_t democracy_clear_public_proposals_V23;
    pd_democracy_unlock_V23_t democracy_unlock_V23;
    pd_democracy_remove_vote_V23_t democracy_remove_vote_V23;
    pd_democracy_remove_other_vote_V23_t democracy_remove_other_vote_V23;
    pd_democracy_cancel_proposal_V23_t democracy_cancel_proposal_V23;
