...
#include "substrate_functions_V17.h"
#include <stddef.h>
#include <stdint.h>

parser_error_t _readMethod_V17(parser_context_t* c, uint8_t moduleIdx, uint8_t callIdx, pd_Method_V17_t* method);
...
parser_error_t _getMethod_ItemValue_V17(
    pd_Method_V17_t* m, uint8_t moduleIdx, uint8_t callIdx, uint8_t itemIdx,
